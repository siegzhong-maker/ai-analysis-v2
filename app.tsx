                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <div className="flex w-full gap-1">
                        ...
                        <div className="flex-1 h-1 bg-slate-800 rounded-full">
                          <div className="h-full bg-orange-600 rounded-full" style={{ width: `${(stat.t2 / stat.max) * 100}%` }} />
                        </div>
                      </div>
                    </div>
                    <span className="text-sm font-bold text-white w-6 text-right">{stat.t2}</span>
                  </div>
                ))}
              </div>
            </div>
